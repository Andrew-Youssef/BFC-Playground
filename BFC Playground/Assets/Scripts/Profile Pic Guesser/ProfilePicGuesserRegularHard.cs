...
public class ProfilePicGuesserRegularHard : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            highScoreMatches.text = "Matches: " + Settings.highestProPicGuesserSuddenDeathHardMatchesScore.ToString();
        }
        else
        {
            mistakesText.text = "Mistakes: " + mistakes.ToString();
            highScoreMatches.text = "Matches: " + Settings.highestProPicGuesserRegularHardMatchesScore.ToString();
            highScoreMistakes.text = "Mistakes: " + Settings.highestProPicGuesserRegularHardMistakesScore.ToString();
        }
    ...
    public void GameOver()
    {
        ...
        if (matches > Settings.highestProPicGuesserRegularHardMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestProPicGuesserRegularHardMatchesScore = matches;
            Settings.highestProPicGuesserRegularHardMistakesScore = mistakes;
        }
        else if (matches == Settings.highestProPicGuesserRegularHardMatchesScore && mistakes < Settings.highestProPicGuesserRegularHardMistakesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestProPicGuesserRegularHardMistakesScore = mistakes;
        }
        ...
        Settings.totalProPicGuesserRegularHardGames++;
    ...
    public void SDGameOver()
    {
        ...
        if (matches > Settings.highestProPicGuesserSuddenDeathHardMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestProPicGuesserSuddenDeathHardMatchesScore = matches;
        }

        Settings.totalProPicGuesserSuddenDeathHardGames++;
        Invoke("ShowGameOverPanel", 0.6f);
    }
}