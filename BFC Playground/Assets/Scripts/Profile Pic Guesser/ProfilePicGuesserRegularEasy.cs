...
public class ProfilePicGuesserRegularEasy : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            highScoreMatches.text = "Matches: " + Settings.highestProPicGuesserSuddenDeathEasyMatchesScore.ToString();
        }
        else
        {
            mistakesText.text = "Mistakes: " + mistakes.ToString();
            highScoreMatches.text = "Matches: " + Settings.highestProPicGuesserRegularEasyMatchesScore.ToString();
            highScoreMistakes.text = "Mistakes: " + Settings.highestProPicGuesserRegularEasyMistakesScore.ToString();
        }
    ...
    public void GameOver()
    {
        ...
        if (matches > Settings.highestProPicGuesserRegularEasyMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestProPicGuesserRegularEasyMatchesScore = matches;
            Settings.highestProPicGuesserRegularEasyMistakesScore = mistakes;
        }
        else if (matches == Settings.highestProPicGuesserRegularEasyMatchesScore && mistakes < Settings.highestProPicGuesserRegularEasyMistakesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestProPicGuesserRegularEasyMistakesScore = mistakes;
        }
        
        Settings.totalProPicGuesserRegularEasyGames++;
    ...
    public void SDGameOver()
    {
        ...
        if (matches > Settings.highestProPicGuesserSuddenDeathEasyMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestProPicGuesserSuddenDeathEasyMatchesScore = matches;
        }
        
        Settings.totalProPicGuesserSuddenDeathEasyGames++;
        Invoke("ShowGameOverPanel", 0.6f);
    }
}