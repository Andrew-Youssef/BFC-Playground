...
public class NameGuesserRegularEasy : MonoBehaviour
{
    ...
    int[] throwaway3 = new int[80];                 // used to put random names in the 9 wrong tiles
    ...
    public void Update()
    {
        ...
        {
            highScoreMatches.text = "Matches: " + Settings.highestNameGuesserSuddenDeathEasyMatchesScore.ToString();
        }
        else
        {
            mistakesText.text = "Mistakes: " + mistakes.ToString();
            highScoreMatches.text = "Matches: " + Settings.highestNameGuesserRegularEasyMatchesScore.ToString();
            highScoreMistakes.text = "Mistakes: " + Settings.highestNameGuesserRegularEasyMistakesScore.ToString();
        }
    ...
    public void GameOver()
    {
        ...
        if (matches > Settings.highestNameGuesserRegularEasyMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestNameGuesserRegularEasyMatchesScore = matches;
            Settings.highestNameGuesserRegularEasyMistakesScore = mistakes;
        }
        else if (matches == Settings.highestNameGuesserRegularEasyMatchesScore && mistakes < Settings.highestNameGuesserRegularEasyMistakesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestNameGuesserRegularEasyMistakesScore = mistakes;
        }

        Settings.totalNameGuesserRegularEasyGames++;
    ...
    public void SDGameOver()
    {
        ...
        if (matches > Settings.highestNameGuesserSuddenDeathEasyMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestNameGuesserSuddenDeathEasyMatchesScore = matches;
        }

        Settings.totalNameGuesserSuddenDeathEasyGames++;
        Invoke("ShowGameOverPanel", 0.6f);
    }
}