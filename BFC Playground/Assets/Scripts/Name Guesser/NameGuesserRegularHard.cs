...
public class NameGuesserRegularHard : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            highScoreMatches.text = "Matches: " + Settings.highestNameGuesserSuddenDeathHardMatchesScore.ToString();
        }
        else
        {
            mistakesText.text = "Mistakes: " + mistakes.ToString();
            highScoreMatches.text = "Matches: " + Settings.highestNameGuesserRegularHardMatchesScore.ToString();
            highScoreMistakes.text = "Mistakes: " + Settings.highestNameGuesserRegularHardMistakesScore.ToString();
        }
    ...
    public void GameOver()
    {
        ...
        if (matches > Settings.highestNameGuesserRegularHardMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestNameGuesserRegularHardMatchesScore = matches;
            Settings.highestNameGuesserRegularHardMistakesScore = mistakes;
        }
        else if (matches == Settings.highestNameGuesserRegularHardMatchesScore && mistakes < Settings.highestNameGuesserRegularHardMistakesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestNameGuesserRegularHardMistakesScore = mistakes;
        }

        Settings.totalNameGuesserRegularHardGames++;
    ...
    public void SDGameOver()
    {
        ...
        if (matches > Settings.highestNameGuesserSuddenDeathHardMatchesScore)
        {
            newHighScore.SetActive(true);
            Settings.highestNameGuesserSuddenDeathHardMatchesScore = matches;
        }

        Settings.totalNameGuesserSuddenDeathHardGames++;
        Invoke("ShowGameOverPanel", 0.6f);
    }
}