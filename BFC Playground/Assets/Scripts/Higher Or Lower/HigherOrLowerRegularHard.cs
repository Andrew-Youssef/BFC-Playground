...
public class HigherOrLowerRegularHard : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        do
        {
            for (int i = 0; i < 3; i++)
            {
                do
                {
                    pictureNum[i] = Random.Range(0, 92);
    ...
    {
       // if (pictureNum[guessingPlayerNum] >= 46)
       // {
//      tileImage.sprite = pictures[46];
     //   }
      //  else
     //   {
    ...
    public void AddMistakes()
    {
        ...
        else if (livesRemaining <= 0)
        {
            ...
            Settings.totalHigherOrLowerRegularHardLosses++;
    ...
    public void AddMatches()
    {
        ...
        {
            Settings.totalHigherOrLowerRegularHardWins++;
        }
    }
    ...
    {
        Settings.totalMistakesInHigherOrLower++;
        Settings.totalHigherOrLowerSuddenDeathHardLosses++;
    ...
    public void SDAddMatches()
    {
        ...
        if (matchBool[0] == true && matchBool[1] == true && matchBool[2] == true)
        {
            Settings.totalHigherOrLowerSuddenDeathHardWins++;
            timerIsRunning = false;
