...
public class HigherOrLowerRegularMedium : MonoBehaviour
{
    ...
    public void AddMistakes()
    {
        ...
        else if (livesRemaining <= 0)
        {
            ...
            Settings.totalHigherOrLowerRegularMediumLosses++;
    ...
    public void AddMatches()
    {
        ...
        {
            Settings.totalHigherOrLowerRegularMediumWins++;
        }
    }
    ...
    {
        Settings.totalMistakesInHigherOrLower++;
        Settings.totalHigherOrLowerSuddenDeathMediumLosses++;
    ...
    public void SDAddMatches()
    {
        ...
        if (matchBool[0] == true && matchBool[1] == true && matchBool[2] == true)
        {
            Settings.totalHigherOrLowerSuddenDeathMediumWins++;
            timerIsRunning = false;
